...
dataset_path = file_path.joinpath('Dataset_Final\\Dataset_test_50_RBKN')
...
def generate_images(fonts, process_id):
    ...
    for font in fonts[:]:
        ...
        try:
            ...
            """
            command_str  = f"trdg --output_dir \"{synthetic_font_path}\" -c {total_images_per_font} -bl 3 -rbl -k 6 -rk -f 105 -ft \"{font_type_used}\""
